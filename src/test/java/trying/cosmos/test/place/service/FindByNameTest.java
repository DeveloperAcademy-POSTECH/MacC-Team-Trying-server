...
public class FindByNameTest {
    ...
    class success {
        ...
        @Test
        @DisplayName("이름을 포함한 장소 목록을 반환한다.")
        void find() throws Exception {
            ...
            // WHEN
            Slice<PlaceDistanceProjection> places = placeService.findByName("푸드", latitude, longitude, pageable);
