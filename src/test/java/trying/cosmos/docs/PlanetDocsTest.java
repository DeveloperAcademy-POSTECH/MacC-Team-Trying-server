...
public class PlanetDocsTest {
    ...
    void findCourses() throws Exception {
        ...
        courseService.create(user.getId(), planet.getId(), TITLE + 1, BODY, Access.PUBLIC, tagDto1);
        courseService.create(user.getId(), planet.getId(), TITLE + 2, BODY, Access.PRIVATE, tagDto2);
