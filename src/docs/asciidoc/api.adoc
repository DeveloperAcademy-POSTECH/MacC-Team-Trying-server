...
include::{snippets}/user-docs-test/join/response-fields.adoc[]
...
==== Request
include::{snippets}/user-docs-test/find_activity/http-request.adoc[]
include::{snippets}/user-docs-test/find_activity/request-headers.adoc[]

==== Response
include::{snippets}/user-docs-test/find_activity/http-response.adoc[]
include::{snippets}/user-docs-test/find_activity/response-fields.adoc[]
...
==== Request
include::{snippets}/user-docs-test/find_liked_course/http-request.adoc[]
include::{snippets}/user-docs-test/find_liked_course/request-headers.adoc[]

==== Response
include::{snippets}/user-docs-test/find_liked_course/http-response.adoc[]
include::{snippets}/user-docs-test/find_liked_course/response-fields.adoc[]
